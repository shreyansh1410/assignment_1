...
function Gallery() {
  return (
    <div
      className="rounded-lg p-4 shadow-lg mt-2 flex items-start"
    ...
    >
      ...
      <svg
        ...
        className="mr-4" // Add margin-right to create space between SVG and right section
      >
        <path
      ...
      {/* Arrows and UploadButton */}
      <div className="flex items-center space-x-2">
        {" "}
        {/* Changed from space-x-4 to space-x-2 */}
        <SliderControls />
        <UploadButton />
      </div>
    </div>
